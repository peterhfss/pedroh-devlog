...
export const projects = [
    ...
    { name: "pedroh-devlog", desc: "My personal dev blog documenting my Full-Stack journey, one commit at a time.", lang: "TypeScript", langColor: "#3178c6", url: "https://github.com/peterhfss/pedroh-devlog"},
]
